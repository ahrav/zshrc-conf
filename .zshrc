...
export PATH=$PATH:/opt/homebrew/Cellar/go/1.20.1/libexec/bin
...
export PATH="/Users/ahrav.dutta/.local/bin:$PATH"
...
source /Users/ahrav.dutta/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
...
alias gdo='git push --delete origin'
alias gpr='git remote prune origin'
alias gst='git stash'
alias grh='git reset HEAD'
alias gsp='git stash pop'
alias gdsb="git branch -vv | grep ': gone]' | grep -v '\*' | awk '{ print $1; }' | xargs -r git branch -D"


#alias sg="ssh git.charm.sh"
...
#alias reboot='function _reboot() { sudo reboot; }; _reboot'
#alias cleanup="find . -type f -name '*.DS_Store' -ls -delete"
#alias emptytash='function _emptytash() { rm -rf ~/.Trash/*; }; _emptytash'


# Gcloud alias
#alias gcab='gcloud app browse'
#alias gcal='gcloud app logs tail -s default'
#alias gcad='gcloud app deploy --project'
...
export PATH="/opt/homebrew/opt/ruby/bin:/opt/homebrew/lib/ruby/gems/3.1.2/bin:$PATH"
